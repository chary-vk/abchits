...
import Chart from "../../Chart"; // plasmic-import: R3N7i0beR5lk/component
import Card from "../../Card"; // plasmic-import: EKQcF2eTIcLL/component
...
import sty from "./PlasmicMonthOverview.module.css"; // plasmic-import: hrsmqgEU8urw/css
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    totalUsersByMonthCustomRange: usePlasmicDataOp(() => {
      return {
        ...
        opId: "b24dc8d7-f225-4865-8aa7-d16515ccf5b1",
        userArgs: {
          query: [$state.start.value]
        },
        cacheKey: `plasmic.$.b24dc8d7-f225-4865-8aa7-d16515ccf5b1.$.`,
    ...
    totalOrdersByDateRange: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "43539864-fae2-4754-96b2-b16c883b4f2e",
        userArgs: {
          query: [$state.start.value, $state.start.value]
        },
        cacheKey: `plasmic.$.43539864-fae2-4754-96b2-b16c883b4f2e.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    currentRevenue: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "3e1b6465-23aa-4811-94a8-5b750a6c3ab2",
        userArgs: {
          query: [$state.start.value, $state.start.value]
        },
        cacheKey: `plasmic.$.3e1b6465-23aa-4811-94a8-5b750a6c3ab2.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    currentTotalCustomers: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "fdafa500-4b00-45e0-ad8f-413776a934f4",
        userArgs: {},
        cacheKey: `plasmic.$.fdafa500-4b00-45e0-ad8f-413776a934f4.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    _12MonthRevenue: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "dd2f1e53-fbc5-4008-ac84-538aa6222d0a",
        userArgs: {
          query: [$state.start.value]
        },
        cacheKey: `plasmic.$.dd2f1e53-fbc5-4008-ac84-538aa6222d0a.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    moMUserGrowth: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "de54e7f0-3ca2-49cc-b55f-b1d5b8236e4e",
        userArgs: {
          query: [
            $state.start.value,
            $state.start.value,
        ...
        cacheKey: `plasmic.$.de54e7f0-3ca2-49cc-b55f-b1d5b8236e4e.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    moMOrderGrowth: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "e4897ec0-b2f4-4adc-8bf9-4d767bfc406d",
        userArgs: {
          query: [
            $state.start.value,
            $state.start.value,
        ...
        cacheKey: `plasmic.$.e4897ec0-b2f4-4adc-8bf9-4d767bfc406d.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    moMAvgOrderGrowth: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "d619ee87-eead-4d09-af22-18430bf4d0fe",
        userArgs: {
          query: [
            $state.start.value,
            $state.start.value,
        ...
        cacheKey: `plasmic.$.d619ee87-eead-4d09-af22-18430bf4d0fe.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    moMRevenueGrowth: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "a7c2f552-4efd-48cd-ad84-5f54afd9616c",
        userArgs: {
          query: [
            $state.start.value,
            $state.start.value,
        ...
        cacheKey: `plasmic.$.a7c2f552-4efd-48cd-ad84-5f54afd9616c.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    currentAvgOrder: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "632c9256-5b77-4aa4-8ef2-ff2e48181263",
        userArgs: {
          query: [$state.start.value, $state.start.value]
        },
        cacheKey: `plasmic.$.632c9256-5b77-4aa4-8ef2-ff2e48181263.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    topCountriesByRevenue: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "a0942620-0797-4acf-8917-ca9cf60a5710",
        userArgs: {},
        cacheKey: `plasmic.$.a0942620-0797-4acf-8917-ca9cf60a5710.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    topProductsByQuantitySold: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "548d54ee-0002-4bae-9661-48e20b7d5ee3",
        userArgs: {
          query: [$state.start.value, $state.start.value]
        },
        cacheKey: `plasmic.$.548d54ee-0002-4bae-9661-48e20b7d5ee3.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    totalProductsSold: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "67fe1a6f-0c63-4fea-8346-17f437200dd9",
        userArgs: {},
        cacheKey: `plasmic.$.67fe1a6f-0c63-4fea-8346-17f437200dd9.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
    topCategoriesByOrders: usePlasmicDataOp(() => {
      return {
        sourceId: "dfE4HU4mpXDEZ8352iqaP2",
        opId: "9485faa8-2cde-4467-abb1-2a4811b35063",
        userArgs: {
          query: [
            $state.start.value,
            $state.start.value,
        ...
        cacheKey: `plasmic.$.9485faa8-2cde-4467-abb1-2a4811b35063.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    })
          ...
          >
            <DataCtxReader__>
              {$ctx => (
                <React.Fragment>
                  <section
                    className={classNames(projectcss.all, sty.section___76WeA)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__hY0RJ)}
                    >
                      <h1
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__p913T)}
                  >
                    <DateTimeRangePicker
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__cxm4T)}
                              displayHeight={"auto"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__uojXf)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__mbnlM)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                      ...
                      <Statistic
                        ...
                        unit={
                          ...
                          >
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img__s1GBo)}
                              displayHeight={"auto"}
                              displayMaxHeight={"28px"}
                              displayMaxWidth={"28px"}
                              displayMinHeight={"0"}
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__izJhB)}
                  >
                    <Chart
                  ...
                  <section
                    className={classNames(projectcss.all, sty.section__bsTqk)}
                  >
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__pGxdD)}
                    >
                      <Card
                        className={classNames(
                          "__wab_instance",
