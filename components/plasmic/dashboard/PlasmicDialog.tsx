...
import Button from "../../Button"; // plasmic-import: DsFm3UIIFOo-/component
...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: XRSTG01v1zsb/css

import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: X3NrfmeYzcsE/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: gwzQtsqkaEgD/icon
      ...
      triggerSlot={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button___7AsiL)}
                >
                  {"Show dialog"}
                </Button>
              ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__ki7Hr)}
              >
                <div
                  className={classNames(
                    projectcss.all,
