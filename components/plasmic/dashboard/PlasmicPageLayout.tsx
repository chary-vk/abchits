...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: rGQpmhEfHPE7/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: p3fU2OmmbzP1/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: R-DK_gq8bMbE/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__cSOuA)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
      ...
      simpleNavTheme={(() => {
        ...
        __composite["customBgColor"] = "#6769BD";
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__iplbP)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__mzX6N)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__yp5Td)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___5JCqn)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
