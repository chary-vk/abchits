...
import sty from "./PlasmicStatistic.module.css"; // plasmic-import: 0-2UvfPZZg33/css
...
function PlasmicStatistic__RenderFunc(props: {
  ...
  return (
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__yEgZe)}>
            <p
              className={classNames(
                projectcss.all,
                projectcss.p,
            ...
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__zIQm4, {
                [sty.imghideIcon__zIQm4P8YLl]: hasVariant(
                  $state,
                  "hideIcon",
                  "hideIcon"
                )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__vYyaD)}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___4ZN7Y, {
            [sty.freeBoxhideIcon___4ZN7Yp8YLl]: hasVariant(
              $state,
              "hideIcon",
              "hideIcon"
            )
        ...
        <div className={classNames(projectcss.all, sty.freeBox__c69J6)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__ym81B, {
              [sty.freeBoxhideTrendTracker__ym81BMzA5B]: hasVariant(
                $state,
                "hideTrendTracker",
                "hideTrendTracker"
              )
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__efM5, {
                [sty.freeBoxhideTrendTracker__efM5MzA5B]: hasVariant(
                  $state,
                  "hideTrendTracker",
                  "hideTrendTracker"
                )
            ...
            >
              <div className={classNames(projectcss.all, sty.freeBox__hf6W)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.freeBox__zn7Vb)}>
              <div className={classNames(projectcss.all, sty.freeBox__eynJf)}>
                {renderPlasmicSlot({
