...
<li><Link href="/new-page">Customers - /new-page</Link></li>
<li><Link href="/add-customer">AddCustomer - /add-customer</Link></li>
<li><Link href="/payments">Payments - /payments</Link></li>
<li><Link href="/add-payment">AddPayment - /add-payment</Link></li>
          </ul>
